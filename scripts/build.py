...
def main():
    ...
    if sys.platform == "darwin":
        gccProc = [[exePath, "gmake", "--cc=gcc"], ["make", "-j", "config=debug_universal"], ["make", "-j", "config=release_universal"], ["make", "-j", "config=distribution_universal"], ["make", "-j", "config=minsizedistribution_universal"]]
        clangProc = [[exePath, "gmake", "--cc=clang"], ["make", "-j", "config=debug_universal"], ["make", "-j", "config=release_universal"], ["make", "-j", "config=distribution_universal"], ["make", "-j", "config=minsizedistribution_universal"]]
    else:
        gccProc = [[exePath, "gmake", "--cc=gcc"], ["make", "-j", "config=debug_x64"], ["make", "-j", "config=release_x64"], ["make", "-j", "config=distribution_x64"], ["make", "-j", "config=minsizedistribution_x64"]]
